      ...
      <div className='flex items-center border border-gray-200 dark:border-gray-800 rounded p-4'>
        {icon == 'react2025' && (
          <div className='h-8 w-8 ml-2 mr-4'>
            ...
            <svg className='h-8 w-8 min-w-sm text-gray-900 dark:text-gray-100' viewBox='0 0 267 305'>
              <g fill='currentColor'>
        ...
        {icon == 'nextjs' && (
          <div className='h-8 w-8 ml-2 mr-4'>
            ...
            <svg className='h-8 w-8 min-w-lg text-gray-900 dark:text-gray-100' viewBox='.5 -.2 1023 1024.1'>
              <g fill='currentColor'>
        ...
        <div>
          ...
          <p className='leading-5 text-gray-700 dark:text-gray-400 mt-2'>{description}</p>
        </div>
      </div>
    </a>
  );
